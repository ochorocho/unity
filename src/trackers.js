...
export const TRACKERS = [
	{ id: 'jira', label: 'Jira', color: '#2684ff', timeTracking: true, attachments: true, emojiShortcodes: false, create: true },
...
export function trackerById(id) {
	return TRACKERS.find((tr) => tr.id === id)
		|| { id, label: id, color: 'var(--color-primary-element)', timeTracking: false, attachments: false, emojiShortcodes: false, create: false }
}
